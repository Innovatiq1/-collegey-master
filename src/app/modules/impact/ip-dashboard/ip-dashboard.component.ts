...
@Component({
     ...
     templateUrl: './ip-dashboard.component.html',
     styleUrls: ['./ip-dashboard.component.css']
   })
   export class IpDashboardComponent  implements OnInit, OnDestroy {
  modalRef: BsModalRef;  
...
//   } 
 ...
 openmessege(template: TemplateRef<any>) {
  this.modalRef = this.modalService.show(template);
  this.modalRef.setClass("modal-width");
}
networkcollege(template: TemplateRef<any>) {
  this.modalRef = this.modalService.show(template);
  this.modalRef.setClass("modal-width");
}
monitor(template: TemplateRef<any>) {
     this.modalRef = this.modalService.show(template);
     this.modalRef.setClass("modal-width");
   }
}