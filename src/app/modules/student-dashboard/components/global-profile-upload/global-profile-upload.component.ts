...
@Component({
  selector: 'app-global-profile-upload',
  templateUrl: './global-profile-upload.component.html',
  styleUrls: ['./global-profile-upload.component.css']
})
export class GlobalProfileUploadComponent implements OnInit {
  user: User;
  @Input() redBorderImage = false;
  @Input() mentorId;
  @Input() ProfilePic;
  @Input() mentorProfileView;
  avatharImage: any;
